...
async function createEmployee() {
  ...
  if (res.code === 0) { showCreate.value = false; createForm.value = { username: '', email: '', displayName: '', password: '', role: 'agent' }; await load() }
  else alert(res.message)
}
function openEdit(employee) { editTarget.value = employee; editForm.value = { username: employee.username, email: employee.email || '', displayName: employee.displayName, role: employee.role } }
